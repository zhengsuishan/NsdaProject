...
class SettingRulesPage(object):
    ...
    def set_points(self):
        ...
        self.driver.find_element(EventRulesLocator.DEBATE_POINT_FIRST[0], EventRulesLocator.DEBATE_POINT_FIRST[1]).clear() #清空输入框
        time.sleep(1.0)
        ...
        time.sleep(1.0)
        self.driver.find_element(EventRulesLocator.DEBATE_POINTS_SECOND[0], EventRulesLocator.DEBATE_POINTS_SECOND[1]).clear()
        time.sleep(1.0)
    ...
    def set_out(self):
        ...
        WebDriverWait(self.driver, self.lodding_time).until(lambda driver:driver.find_element(EventRulesLocator.DEBATE_WIN_NUMBER[0], EventRulesLocator.DEBATE_WIN_NUMBER[1]))

        #--------------------------------先判断是否设置过规则---------------------------------
        try:
            WebDriverWait(self.driver, self.wait_time).until(lambda driver:driver.find_element(EventRulesLocator.FINALS_JUDGMENT[0], EventRulesLocator.FINALS_JUDGMENT[0]))
            pass
        except Exception as e:
